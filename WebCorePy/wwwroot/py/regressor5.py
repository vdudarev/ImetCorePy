...
def evaluateRegressor(classifier, classifierName, classifierMode, X_train, X_test, y_train, y_testEMPTY):
    ...
    if repString=="":
        ...
        methodScoreData.append({'MethodName': classifierName, 'r2score': r2score, 'r2scoreLoo': r2Loo, 
            ...
            'LooCVMeanAbsoluteError_mean': abs(scoresCV_AbsLoo.mean()), 'LooCVNegMeanAbsoluteError_std +/-': abs(scoresCV_AbsLoo.mean()),
            'LooCVMeanSquaredError_mean': abs(scoresCV_SqLoo.mean()), 'LooCVNegMeanSquaredError_std +/-': abs(scoresCV_SqLoo.mean()),
        ...
        methodScoreData.append({'MethodName': classifierName, 'r2score': r2score, 'r2scoreLoo': r2Loo, 
            ...
            'LooCVMeanAbsoluteError_mean': None, 'LooCVNegMeanAbsoluteError_std +/-': None,
            'LooCVMeanSquaredError_mean': None, 'LooCVNegMeanSquaredError_std +/-': None,
...
# 'time', 'ErrorMessage']) 
    dfScore = pd.DataFrame(methodScoreData, columns = ['MethodName', 'r2scoreLoo', 
'LooCVMeanAbsoluteError_mean', 
'LooCVMeanSquaredError_mean', 
'time', 'ErrorMessage']) 
    if ext=="xls" or ext=="xlsx":
